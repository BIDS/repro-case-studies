---
title: Feature Extraction and Data Wrangling for Predictive Models of the Brain in Python
running: Modeling Brain in Python
...
![Diagram](choldgraf.pdf){width=100%}\
