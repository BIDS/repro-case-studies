...
+ connect via secure FTP to the server in Fairbanks and search for new text files across the directory structure
+ ingest each text file into a Pandas dataframe
...
Hosting our resources in a cloud environment played a vital role in making our workflow reproducible. We strongly recommend investigating in one of the many cloud hosting environments currently available to researchers. 
...
I learned these techniques through coursework, an internship at Microsoft Research, and through self-directed learning.
