...
*Short answers (a few sentences each) to general questions about
reproducibility and scientific research.*
...
how the universe has expanded over its history. As Type Ia supernovae
are relatively rare, these studies involve telescope observations of
large areas of sky in order to detect supernovae, followed by
additional more detailed observations when a supernova is
detected. Projects involve tens or hundreds of scientists spread
across many institutions in order to marshall the resources for this
data collection and reduction. The data collection phase of these
projects can last five or even ten years.
...
**4) How or where did you learn the reproducible practices described in
...
**5) What do you see as the major pitfalls to doing reproducible
...
*[NOTE: I'm not sure if this question means "why can't you do
 reproducible research supposing that you wanted to?" or "why don't
 people in your field do reproducible research?" I answered the
 latter, but I suspect the former was intended.]*


**6) What do you view as the major incentives for doing reproducible
research?**
...
*[NOTE: while I can see that it is distict, this question feels
	similar to "why is reproducibility in your domain important"]*


## WORKFLOW NARRATIVE

**Workflow narrative and diagram - a textual narrative describing your
workflow with an accompanying diagram showing your workflow visually.**

I will describe the development of software for analyzing supernova
light curve data.  A "light curve" in the parlance of our domain is
...
from other surveys, as I will discuss below. *[NOTE: Consider putting
this intro paragraph before the diagram?]*
...
to cath and fix problems before they are reported by users. Second,
...
**If applicable, a detailed description of a particular specialized
tool that plays a key role in making your workflow reproducible, if
you think that the tool might be of broader interest or relevance to a
general audience.**
