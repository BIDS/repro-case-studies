...
We found that the mesh quality as well as proper non-reflective boundary conditions were crucial in capturing the features of the wake generated by the snake body cross-section. 
In fact, the mesh generation step is most often what determines the quality of the solution, and some meshes would result in markedly different results.
